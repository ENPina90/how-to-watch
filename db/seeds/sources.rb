...
SOURCES = [
  ...
  },
  {
    ...
    autoplay_param: "autoplay", position: 3, active: false,
    templates: {
  ...
  {
    slug: "google-drive", name: "Google Drive", kind: "direct", position: 4, active: true,
    templates: { "default" => "https://drive.google.com/file/d/%{source_key}/preview" },
  },
  {
    slug: "mega", name: "MEGA", kind: "direct", position: 5, active: true,
    templates: { "default" => "https://mega.nz/embed/%{source_key}" },
  },
  {
    slug: "youtube", name: "YouTube", kind: "direct", position: 6, active: true,
    templates: { "default" => "https://www.youtube.com/embed/%{source_key}" },
  },
  {
    slug: "archive-org", name: "Internet Archive", kind: "direct", position: 7, active: true,
