...
ActiveRecord::Schema[8.1].define(version: 2026_09_15_130000) do
  ...
  create_table "app_settings", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.integer "up_next_lead_seconds", default: 15, null: false
  ...
  create_table "cable_slots", force: :cascade do |t|
    ...
    t.index ["era", "airs_on", "position"], name: "index_cable_slots_on_era_and_airs_on_and_position", unique: true, where: "(era IS NOT NULL)"
    t.index ["era", "starts_at", "ends_at"], name: "index_cable_slots_on_era_and_starts_at_and_ends_at", where: "(era IS NOT NULL)"
    ...
    t.check_constraint "(list_id IS NULL) <> (era IS NULL)", name: "cable_slots_one_channel"
  end
  ...
  create_table "lists", force: :cascade do |t|
    ...
    t.string "settings"
    t.integer "skip_credits_seconds"
    t.integer "skip_intro_seconds"
    t.string "sort"
    t.datetime "updated_at", null: false
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.float "randomizer", default: 0.0, null: false
    ...
    t.index ["favorite_list_id"], name: "index_users_on_favorite_list_id"
  ...
  create_table "watch_parties", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.bigint "entry_id", null: false
    t.boolean "guests_can_control", default: true, null: false
  ...
  add_foreign_key "users", "lists", column: "favorite_list_id", on_delete: :nullify
