class UpdateVidsrcSourcesForEpisodes < ActiveRecord::Migration[8.0]
  def up
    ...
    entries_to_update.find_each do |entry|
      ...
      if imdb_match
        ...
        entry.update_columns(
          ...
          source: "https://vidsrc.cc/v3/embed/tv/#{imdb_id}/#{entry.season}/#{entry.episode}"  # New source format
        )
